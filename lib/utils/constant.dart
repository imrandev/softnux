class Constant {
  ...
  static const String passwordRegEx = '[0-9a-zA-Z]{8,}';
  ...
  static const String passwordErrorMessage = "Password is too short, Need at least 8 characters!";
  static const String nameErrorMessage = "First name required!";
